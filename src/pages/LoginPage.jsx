      ...
      <AnimatePresence>
        {authStage === 'login' && !showIntro && (
          ...
          >
            ...
            <div className="relative w-full lg:w-[55%] min-h-[30vh] lg:min-h-screen flex flex-col justify-between p-12 md:p-24 z-10 overflow-hidden">
               <div className="absolute inset-0 bg-gradient-to-br from-rose-500/10 via-transparent to-rose-900/5 pointer-events-none" />
               <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} className="relative z-10 flex items-center gap-6">
                 <div className="w-20 h-20 md:w-28 md:h-28 bg-black/20 border border-white/10 rounded-[2.5rem] p-6 flex items-center justify-center backdrop-blur-3xl shadow-2xl group transition-all duration-700 hover:border-rose-500/30">
                 ...
                 <div className="flex flex-col">
                   <h2 className="text-2xl md:text-3xl font-black text-rose-50 tracking-[0.2em] leading-none">HURA <span className="rose-gold-gradient">GROUP</span></h2>
                   <div className="flex items-center gap-3 mt-4">
                       <div className="w-1.5 h-1.5 rounded-full bg-rose-500 animate-pulse" />
                       <p className="text-[9px] font-black text-white/20 uppercase tracking-[0.5em]">Secure_Node_Active</p>
                   </div>
                 </div>
               </motion.div>
               ...
               <div className="relative z-10 opacity-10 flex items-center gap-4">
            ...
            {/* Right Column (Form) */}
            <div className="relative flex-1 min-h-[70vh] lg:min-h-screen bg-black/40 backdrop-blur-[100px] flex flex-col justify-center px-12 md:px-24 py-24 z-10 lg:border-l border-white/5 shadow-[-50px_0_150px_rgba(0,0,0,0.5)]">
